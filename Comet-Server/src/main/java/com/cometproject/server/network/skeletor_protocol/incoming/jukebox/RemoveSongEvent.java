...
import com.cometproject.server.network.skeletor_protocol.outgoing.jukebox.RemoveSongComposer;

public class RemoveSongEvent extends IncomingSkeletorMessage<RemoveSongEvent.JSONRemoveSongEvent> {
