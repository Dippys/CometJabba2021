        ...
        if (floorItem instanceof FootballFloorItem) {
            ...
            if (PlayerManager.getInstance().isOnline(playerId)) {
                ...
                if (session != null && session.getPlayer() != null && session.getPlayer().getAchievements() != null) {
                    //pEntity.getPlayer().getEntity().getRoom().getEntities().broadcastMessage(new ActionMessageComposer(session.getPlayer().getEntity().getId(), PlayerAvatarActions.EXPRESSION_RESPECT.getValue()));
