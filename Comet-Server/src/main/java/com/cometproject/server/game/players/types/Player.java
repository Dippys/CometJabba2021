...
public class Player extends Observable implements IPlayer {
    ...
    private MisteryComponent mistery;
    ...
    private List<PlayerMention> mentions = new ArrayList<PlayerMention>();
    ...
    public Player(ResultSet data, boolean isFallback) throws SQLException {
        ...
        this.whisperGroupUser = new ArrayList<String>();
    ...
    public void getCalendarGifts(){
        ...
        for(int i = 0; i < this.calendarGifts.length; i++){
            this.calendarGifts[i] = false;
        }
