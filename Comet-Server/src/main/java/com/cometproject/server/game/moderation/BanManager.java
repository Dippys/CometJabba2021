...
public class BanManager implements Initialisable {
    ...
    public void banPlayer(BanType type, String data, String userBanned, int length, long expire, String reason, int bannerId, String userAddedBan) {
        int banId = BanDao.createBan(type, length, expire, data, userBanned, bannerId, userAddedBan, reason);
