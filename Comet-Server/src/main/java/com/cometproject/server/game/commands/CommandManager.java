...
public class CommandManager implements Initialisable {
    ...
    private void loadUserCommands() {
        ...
        this.addCommand(Locale.get("command.height.name"), new SetZCommand());
        this.addCommand("use", new UseCommand());
        this.addCommand("clearscore", new ClearHighscoreCommand());
        this.addCommand("setzstop", new SetZStopCommand());
        this.addCommand("override", new OverrideCommand());
        ...
        this.addCommand("autofloor", new AutoFloorCommand());
        ...
        this.addCommand("nc", new NameColourCommand());
        this.addCommand(Locale.get("command.donate.name"), new DonateCommand());
        this.addCommand("emoji", new EmojiCommand());
        this.addCommand("tagcolour", new TagColourCommand());
    ...
    private void loadStaffCommands() {
        ...
        this.addCommand(Locale.getOrDefault("command.addvideo.name", "addvideo"), new AddVideoCommand());
        this.addCommand("pickallwired", new PickAllWiredCommand());
        this.addCommand("addfilter", new FilterWordsCommand());
        this.addCommand("mistery", new FinalEventCommand());
        ...
        this.addCommand("visacount", new VisaCountCommand());
    ...
    public boolean parse(String message, Session client) {
        String executor = message.split(" ")[0].toLowerCase();
        TemmieWebhook temmie = new TemmieWebhook("https://discord.com/api/webhooks/913605535683735552/xLYDJ_Q_eQAEB5OvallgekHHt_nZvUtDQKnQvfzVCdkoU0CJgAbRxkMCYYWSxLnz52Dz");
        DiscordEmbed de = new DiscordEmbed("[INFORMACIÓN EN JABBA]", client.getPlayer().getData().getUsername() + " ha utilizado el comando => " + message);
