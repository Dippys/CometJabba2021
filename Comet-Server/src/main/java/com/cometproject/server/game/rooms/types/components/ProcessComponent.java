...
public class ProcessComponent implements CometTask {
    ...
    private boolean adaptiveProcessTimes;
    ...
    public void tick() {
        ...
        try {
             ...
             */
            List<RoomEntity> shuffledEntities = new ArrayList<>(entities.values());
            Collections.shuffle(shuffledEntities);
            for (RoomEntity entity : shuffledEntities) {
