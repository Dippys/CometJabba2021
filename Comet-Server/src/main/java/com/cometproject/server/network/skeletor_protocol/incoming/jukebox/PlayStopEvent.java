...
import com.cometproject.server.network.skeletor_protocol.outgoing.jukebox.PlayStopComposer;

public class PlayStopEvent extends IncomingSkeletorMessage<PlayStopEvent.JSONPlayStopEvent> {
