...
public class WhisperMessageEvent implements Event {
    public void handle(Session client, MessageEvent msg) {
        ...
        if (user.equalsIgnoreCase("grupo")) {
            for (String username : client.getPlayer().getGroupWhispers()) {
                ...
                if (!client.getPlayer().getPermissions().getRank().roomFilterBypass()) {
                    ...
                    if (filterResult.isBlocked()) {
                        ...
                        client.getLogger().info((Object)("Filter detected a blacklisted word in message: \"" + message + "\""));
                        continue;
                    }
            ...
            client.send(new WhisperMessageComposer(playerEntity.getId(), "<b>" + client.getPlayer().getData().getUsername() + "</b>, al grupo: " + message, 0));
