...
public class SuperBanCommand extends ChatCommand {
    ...
    public void execute(Session client, String[] params) {
        ...
        BanManager.getInstance().banPlayer(BanType.USER, Integer.toString(user.getPlayer().getId()), user.getPlayer().getEntity().getUsername(), expire, expire, "Superban", client.getPlayer().getId(), client.getPlayer().getEntity().getUsername());
