...
import com.cometproject.server.game.fastfood.messages.incoming.OverrideGameCenterJoinGameEvent;
...
//        this.eventExecutor = asyncEventExecution ? Executors.newFixedThreadPool(Integer.parseInt((String) Configuration.currentConfig().getOrDefault("comet.network.alternativePacketHandling.threads", "8"))) : null;
    ...
    public void registerCrafting() {
        this.getMessages().put(Events.RequestCraftingRecipesAvailableMessageEvent, new GetCraftingRecipesAvailableMessageEvent()); //ready
        this.getMessages().put(Events.CraftingCraftSecretMessageEvent, new CraftSecretMessageEvent()); //ready
        this.getMessages().put(Events.CraftingAddRecipeMessageEvent, new ViewCraftingRecipeMessageEvent()); //ready
        this.getMessages().put(Events.CraftingCraftItemMessageEvent, new ExecuteCraftingRecipeMessageEvent()); //ready
        this.getMessages().put(Events.RequestCraftingRecipesMessageEvent, new GetCraftingItemMessageEvent()); //ready
    }
    ...
    public void registerRoom() {
        ...
        //this.getMessages().put(Events.WhiperGroupMessageEvent, new WhiperGroupMessageEvent());
    ...
    public void registerCatalog() {
        ...
        this.getMessages().put(Events.GetClubDataEvent, new GetClubPresentMessageEvent());
        this.getMessages().put(Events.RequestClubGiftsMessageEvent, new GetPresentsPageMessageEvent());
    }
