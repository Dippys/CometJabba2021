...
public class SlotMachineFloorItem extends RoomItemFloor {
    ...
    public boolean onInteract(RoomEntity entity, int requestData, boolean isWiredTrigger) {
        ...
        if(((PlayerEntity) entity).getPlayer().getData().getSeasonalPoints() < ((PlayerEntity) entity).getBetAmount() || ((PlayerEntity) entity).getBetAmount() == 0){
        ...
        ((PlayerEntity) entity).getPlayer().getData().decreaseSeasonalPoints(((PlayerEntity) entity).getBetAmount());
        ...
        if(random1 == random2 && random2 == random3 && random1 == random3) {
            ...
            ((PlayerEntity) entity).getPlayer().getData().increaseSeasonalPoints(((PlayerEntity) entity).getBetAmount() * multiplier);
