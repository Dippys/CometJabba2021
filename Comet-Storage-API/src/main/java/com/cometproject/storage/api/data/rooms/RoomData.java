...
public class RoomData implements IRoomData {
    ...
    private boolean visaCount;
    private boolean wiredCustomStateChanged;
    ...
    public RoomData(int id, RoomType type, String name, String description, int ownerId, String owner, int category,
                    ...
                    String requiredBadge, String thumbnail, boolean wiredHidden, int userIdleTicks, boolean visaCount, boolean wiredCustomStateChanged) {
        this.id = id;
        this.type = type;
        this.name = name;
        ...
        this.wiredCustomStateChanged = wiredCustomStateChanged;
    }
    ...
    @Override
    public boolean isVisaCount() {
        return this.visaCount;
    }

    @Override
    public void setVisaCount(boolean visaCount) { this.visaCount = visaCount; }

    @Override
    public boolean isWiredCustomStateChanged() { return wiredCustomStateChanged;}

    @Override
    public void setWiredCustomStateChanged(boolean wiredCustomStateChanged) { this.wiredCustomStateChanged = wiredCustomStateChanged;}
}
