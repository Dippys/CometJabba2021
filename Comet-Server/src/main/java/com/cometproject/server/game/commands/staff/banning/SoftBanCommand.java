...
public class SoftBanCommand extends ChatCommand {
    ...
    public void execute(Session client, String[] params) {
        ...
        BanManager.getInstance().banPlayer(BanType.USER, user.getPlayer().getId() + "", user.getPlayer().getEntity().getUsername(), 2, expire, params.length > 1 ? this.merge(params, 1) : "", client.getPlayer().getId(), client.getPlayer().getEntity().getUsername());
