...
public class Comet {
    ...
    /**
     * System with initialize emulator with password
     */
    /*public static void promptEnterKey() {
        System.out.println("Introduce tu KEY para poder utilizar Comet-Server....");
        Scanner reader = new Scanner(System.in);
        String sTexto = reader.next();
        if(!sTexto.equals("GABBUZUS2021DANN")) {
            Comet.exit("Haz introducido una key incorrecta, por seguridad el emulador se apago automaticamente.");
        }
        System.out.println("Introduce tu KEY nuevamente para poder utilizar Comet-Server....");
        do {
            sTexto = reader.next();
        } while(!sTexto.equals("GABBUZUS2021DANN"));
    }*/
