...
public class RoomDao {
    ...
    public static void updateVisaCount(boolean visaCount, int roomId) {
        Connection sqlConnection = null;
        PreparedStatement preparedStatement = null;
        ...
        try {
            ...
            preparedStatement.setBoolean(1, visaCount);
            preparedStatement.setInt(2, roomId);
    ...
    private static IRoomData roomDataFromResultSet(final ResultSet room) throws SQLException {
        ...
        final boolean visaCount = room.getBoolean("visa_count");
        final boolean wiredCustomStateChanged = room.getBoolean("wf_cstm_state_changed");
        ...
        return new RoomData(id, type, name, description, ownerId, owner, category, maxUsers, access, password,
                ...
                requiredBadge, thumbnail, wiredHidden, userIdleTicks, visaCount, wiredCustomStateChanged);
    }
