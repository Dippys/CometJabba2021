...
public abstract class RollableFloorItem extends RoomItemFloor {
    ...
    public void onEntityStepOn(RoomEntity entity) {
        ...
        boolean isKickingMove = (this.getPosition().getY() == entity.getWalkingGoal().getY() && this.getPosition().getX() == entity.getWalkingGoal().getX() && (entity.getPreviousSteps() == 1 || this.kickerEntity != entity)); // && entity.getPreviousSteps() == 1;
