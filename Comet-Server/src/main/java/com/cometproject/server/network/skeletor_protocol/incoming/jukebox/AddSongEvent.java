...
import com.cometproject.server.network.skeletor_protocol.outgoing.jukebox.AddSongComposer;

public class AddSongEvent extends IncomingSkeletorMessage<AddSongEvent.JSONAddSong> {
