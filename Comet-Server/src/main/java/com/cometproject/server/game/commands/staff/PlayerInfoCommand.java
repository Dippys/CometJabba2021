...
public class PlayerInfoCommand extends ChatCommand {
    ...
    public void execute(Session client, String[] params) {
        ...
        userInfo.append("<b>" + Locale.getOrDefault("command.playerinfo.gender", "Genero") + "</b>: " + (playerData.getGender().toLowerCase().equals("m") ? Locale.getOrDefault("command.playerinfo.male", "Male") : Locale.getOrDefault("command.playerinfo.female", "Female")) + "<br>");
        ...
        userInfo.append("<b>" + Locale.getOrDefault("command.playerinfo.achievementPoints", "VIP") + "</b>: " + playerData.isVip() + "<br>");
