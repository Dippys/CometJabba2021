...
public class Events {
    ...
    public static final int PongEvent = 2596 ; // 1552 // check
    public static final int RequestTalenTrackEvent = 196;
    public static final int ConfirmUsernameMessageEvent = 3878 ; // 1590 // check
    ...
    public static final int GenerateSecretKeyMessageEvent = 773 ; // 412 // check
    ...
    public static final int SSOTicketMessageEvent = 2419 ; // 286 // check
    ...
    public static final int UniqueIDMessageEvent = 2490 ; // 921 // check
    public static final int RemoveMyRightsMessageEvent = 3182 ; // 3596
    public static final int PurchaseTargetOfferEvent = 1826;
    public static final int ApplyHorseEffectMessageEvent = 1328 ; // 2160
    ...
    public static final int EventLogMessageEvent = 3457 ; // 658 // check
    ...
    public static final int OpenFlatConnectionMessageEvent = 2312 ; // 2450 // check
    ...
    public static final int LatencyTestMessageEvent = 295 ; // 2348 // check
    ...
    public static final int DeleteGroupReplyMessageEvent = 286 ; // 1616 // check
    ...
    public static final int GetClientVersionMessageEvent = 4000 ; // 4000 // check
    ...
    public static final int InitCryptoMessageEvent = 2688 ; // 3347 // check
    ...
    public static final int GoToHotelViewMessageEvent = 105 ; // 2644 // check
    ...
    public static final int ClientVariablesMessageEvent = 1053 ; // 3638 // check
    ...
    public static final int GetMarketplaceConfigMessageEvent = 2597 ; // 1231 check
    ...
    private static Map<Integer, String> eventPacketNames = new HashMap<>();
