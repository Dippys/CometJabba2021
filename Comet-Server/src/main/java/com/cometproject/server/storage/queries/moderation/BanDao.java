...
public class BanDao {
    ...
    public static int createBan(BanType type, long length, long expire, String data, String userBanned, int addedBy, String userAddedBan, String reason) {
        ...
        try {
            ...
            preparedStatement = SqlHelper.prepare("INSERT into bans (`type`, `expire`, `data`, `user_banned`, `reason`, `added_by`, `user_addedban`) VALUES(?, ?, ?, ?, ?, ?, ?);", sqlConnection, true);
