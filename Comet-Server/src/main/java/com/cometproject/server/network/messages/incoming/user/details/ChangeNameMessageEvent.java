...
public class ChangeNameMessageEvent implements Event {
    public void handle(Session client, MessageEvent msg) {
        ...
        if (newName.toLowerCase().contains("mod") || newName.toLowerCase().contains("adm") || newName.toLowerCase().contains("gay") || newName.toLowerCase().contains("puto") || newName.toLowerCase().contains("puta") || newName.toLowerCase().contains("hijadeputa") || newName.toLowerCase().contains("admin") || newName.toLowerCase().contains("m0d") || newName.toLowerCase().contains("mob") || newName.toLowerCase().contains("m0b") || newName.toLowerCase().contains("OWN") || newName.toLowerCase().contains("DEV") || newName.length() > 15 || newName.length() < 3 || inUse) {
            return;
        }
